...
export const fromDb = {
  ...
  scope: r => ({ id: r.id, projectId: r.project_id, name: r.type, type: r.type, dataSource: r.data_source, scopeValue: r.qty, coatingsPotential: r.coatings_potential || 0, protectonOpportunity: r.protecton_opportunity || 0, qty: r.qty, qtyUnit: r.qty_unit, notes: r.notes, products: r.products || [], stage: r.stage, specStatus: r.spec_status }),
...
export const toDb = {
  ...
  scope: s => ({ id: s.id, project_id: s.projectId, type: s.type || s.name, data_source: s.dataSource, coatings_potential: s.coatingsPotential || 0, protecton_opportunity: s.protectonOpportunity || 0, qty: s.qty || null, qty_unit: s.qtyUnit, notes: s.notes, products: s.products || [], stage: s.stage, spec_status: s.specStatus, updated_at: new Date().toISOString() }),
